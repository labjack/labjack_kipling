...
function performListAllTCP() {
	...
	var openAllData = ljm.LJM_OpenAll(7, 2, 0, aHandles, 0,0, '');
...
function performListAllUDP() {
	...
	var openAllData = ljm.LJM_OpenAll(7, 5, 0, aHandles, 0,0, '');
...
function performListAllDigit() {
	...
	var openAllData = ljm.LJM_OpenAll(200, 0, 0, aHandles, 0,0, '');
