...
-- Disable the DIO_EF at dionum before configuring
MB.WA(44000+dioregoffset, U16_TYPE_CONSTANT, NUM_U16_PER_U32, u32_to_u16_array(0))
-- Set index to 0 for PWM
MB.WA(44100+dioregoffset, U16_TYPE_CONSTANT, NUM_U16_PER_U32, u32_to_u16_array(0))
-- Set options to 0 for using clock source 0
MB.WA(44200+dioregoffset, U16_TYPE_CONSTANT, NUM_U16_PER_U32, u32_to_u16_array(0))
-- Set the high to low transition point
MB.WA(44300+dioregoffset, U16_TYPE_CONSTANT, NUM_U16_PER_U32, u32_to_u16_array(configa))
-- Enable the feature to start outputting the PWM
MB.WA(44000+dioregoffset, U16_TYPE_CONSTANT, NUM_U16_PER_U32, u32_to_u16_array(1))
