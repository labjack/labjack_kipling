...
function module() {
    ...
    function openAppCFGFile(appName) {
        console.log('Opening config file for app:', appName);
        var cfgFileName = appName + '_open.cfg';
    ...
    **/
    this.onModuleLoaded = function(framework, onError, onSuccess) {
        ...
        var customSmartBindings = [{
            ...
            bindingName: 'lj-file-link-holder-ljLogMApp',
            smartName: 'clickHandler',
            callback: openLJLogMOpenConfigFile,
        }, {
            bindingName: 'lj-file-link-holder-ljStreamMApp',
            smartName: 'clickHandler',
            ...
            smartName: 'clickHandler',
            callback: configAndOpenLJLogMApplication,
        }, {
            bindingName: 'lj-config-and-open-link-holder-ljStreamMApp',
            smartName: 'clickHandler',
            callback: configAndOpenLJStreamMApplication,
        }];
