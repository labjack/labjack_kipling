    ...
    this.saveModuleStartupData = function(callerInfo) {
        ...
        if(saveData) {
            ...
            var innerSaveStartupData = function() {
                console.log('in innerSaveStartupData', moduleName, self.currentModuleName);
                    ...
                    if(curFormat !== 'customFormat') {
                        if(isNaN(value)) {
                            ...
                            if(typeof(value) === 'number') {
                                ...
                                console.warn('Replacing a non-value in createSuccessfulReadFunc', value);
                                formattedValue = 0;
                            }
                        }
                    } else {
                ...
                if(curFormat !== 'customFormat') {
                    if(isNaN(curVal)){
                        ...
                        if(typeof(curVal) === 'number') {
                            ...
                            console.warn('Replacing a non-value in processDeviceValues', curVal);
                            stringVal = 0;
                        }
