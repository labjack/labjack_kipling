...
/* global showAlert, showCriticalAlert, package_loader */
/* global MODULE_LOADER, MODULE_CHROME,  */
        ...
        try {
            ...
            if(data.deviceInfo) {
                ...
                if(self.deviceErrorControls[sn]) {
                    ...
                    // Render and display the error message
                    var compiledMessage = self.deviceErrorCompiledTemplate(data);
