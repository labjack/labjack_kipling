...
function module() {
    ...
    this.updateIPSettings = function(type) {
        console.log('Updating IP Settings',type);
        var list = [];
        if(type === 'wifi') {
    ...
    this.updateEthernetSettings = function() {
        console.log('in updateEthernetSettings');
    ...
    this.updateWifiSettings = function() {
        console.log('in updateWifiSettings');
        ...
        var wifiStatusListner = function(data, onSuccess) {
            ...
            if(currentStatus == newStatus) {
                ...
                if( newStatus == 2900 ) {
                    ...
                    console.log('Wifi SSID: (on connect-change)',self.activeDevice.sRead('WIFI_SSID'));
    ...
    **/
    this.configureModuleContext = function(framework) {
        ...
        try {
            ...
            console.log('HERE', networkInterfaces);
