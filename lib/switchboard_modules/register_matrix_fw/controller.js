...
function module() {
    ...
    **/
    ...
    this.formatChildTable = function(data, searchTerm) {
        ...
        console.log('in formatChildTable', searchTerm);
        var context = {};
        var childTable;
        ...
        */
        ...
        .DataTable({
            ...
            'rowCallback': function( rowElement, data, pageIndex ) {
                ...
                self.recentlyUpdatedRows.push({'index': rowIndex, 'isSelected': currentState});
            },
        ...
        $(tableElementStr).on('click', 'td.ct-select-control', function() {
            ...
            if(registerName) {
                ...
                console.log('in ct select', registerName, newState);
        ...
        $(tableElementStr).on('click', 'td.select-control', function() {
            ...
            if(filteredChildData.length > 1) {
                console.log('Expanding child-row');
