...
// WILL NEED THESE EVENTUALLY... - Jimmy
...
class CREATE_SIMPLE_LOGGER extends EventEmitter () {
    ...
    constructor() {
        ...
        */
        ...
        function innerStartLogger(loggerConfig) {
            var defered = q.defer();
        ...
        // var self = this; // not sure if we need this, if stuff is broken, try uncommenting this, damn the scope - Jimmy
    }
}
...
exports.generateBasicConfig = function(basicData, devices) {
	...
	var validSN;
    // REWRITE THIS FOR SINGLE DEVICE STUFF ONLY -- Jimmy, Zander
    // Add device sn and device name?? (if possible) to data configuration -- Zander
