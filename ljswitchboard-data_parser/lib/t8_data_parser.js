...
var T8_LIST = {
	...
	'WIFI_STATUS': {
		...
		'decode': function(res) {
			var str = checkStr(T8_LIST.WIFI_STATUS.valToString[res]);
	...
	'WIFI_RSSI': {
		...
		'decode': function(res) {
			...
			var WIFI_RSSI_IMAGES = T8_LIST.WIFI_RSSI.images;
